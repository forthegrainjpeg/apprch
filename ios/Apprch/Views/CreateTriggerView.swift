        ...
        Form {
            ...
            if let editing {
                Section("NFC tag") {
                    ...
                    Text("Write this onto a tag. Tapping it later opens Apprch and logs the Task.")
                        .font(.caption)
                        .foregroundStyle(.secondary)
    ...
    private func createdState(triggerId: String) -> some View {
        ...
        return VStack(spacing: 20) {
            ...
            Text(name.isEmpty ? "Task created" : name)
                .font(.title2.bold())
            Text("Hold your iPhone on a tag to write this Task. Tapping the tag later opens Apprch and logs it.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
